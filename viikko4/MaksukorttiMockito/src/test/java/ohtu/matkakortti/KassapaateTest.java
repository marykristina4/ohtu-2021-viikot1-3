...
public class KassapaateTest {
    ...
    public void kortiltaEiVelotetaJosRahaEiRiita() {
        ...
        @Test
    public void kortilleLadataanHintaJosSummaPositiivinen() {
        //when(kassa.getSaldo()).thenReturn(10);
        kassa.lataa(kortti, 5);
        
        //verify(kassa, times(1)).getSaldo();
        verify(kortti).lataa(eq(5));
    }
           @Test
    public void kortilleEiLadataHintaJosSummaNegatiivinen() {
        //when(kassa.getSaldo()).thenReturn(10);
        kassa.lataa(kortti, -5);
